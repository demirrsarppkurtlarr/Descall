...
const FALLBACK_DOWNLOAD_URL = "https://github.com/demirrsarppkurtlarr/Descall/releases/download/v1.0.12/Descall-Setup-1.0.12.exe";
    ...
    try {
      ...
      if (response.status === 404) {
        ...
        if (FALLBACK_DOWNLOAD_URL) {
          ...
          setLatestRelease({ tag_name: 'v1.0.12' }); // Update version manually
        } else {
