...
const FALLBACK_DOWNLOAD_URL = "https://github.com/demirrsarppkurtlarr/Descall/releases/download/v1.1.0/Descall-Setup-1.1.0.exe";
    ...
    try {
      ...
      if (response.status === 404) {
        ...
        if (FALLBACK_DOWNLOAD_URL) {
          ...
          setLatestRelease({ tag_name: 'v1.1.0' }); // Update version manually
        } else {
